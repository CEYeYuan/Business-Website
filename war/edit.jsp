        ...
        <div class="content1">	
           	<div class="cart_total">
                ...
                <div class="order_info">
	                <p>Name: <input name='ordername' value='<% out.print(ordername); %>'></p>
	                <p>Phone: <input name='phone' value='<% out.print(phone); %>'></p>
	                <p>Post Code: <input name='mail' value='<% out.print(mail); %>'></p>
                </div>
                <div  class="order_info">
	                <p>Email: <input name='email' value='<% out.print(email); %>' ></p>
	                <p>Address:<input name='address' value='<% out.print(address); %>'></p>
	                <p>Status: <input name='status' value='<% out.print(status); %>'></p>
                </div>
